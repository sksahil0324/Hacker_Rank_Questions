...
def print_formatted(number):
    width = len(bin(number)) - 2  # -2 to remove the '0b' prefix (while converting to binary it will show ob(converted no))
    for i in range(1, number + 1):
        # Print the formatted output: decimal, octal, hexadecimal, binary
